"steam/cached/SettingsSubInterface.res" {
	styles {
		CSubPanelOptionsInterface {
			render {
				0="fill(x0+70,y0+191,x1,y0+239, customgreymenu)"
				1="fill(x0+70,y0+286,x1,y0+312, customgreymenu)"
				2="fill(x0+70,y0+358,x1,y0+384, customgreymenu)"
			}

			render [$OSX] {
				0="fill(x0+70,y0+97,x1,y0+136, customgreymenu)"
				1="fill(x0+70,y0+192,x1,y0+214, customgreymenu)"
				2="fill(x0+70,y0+264,x1,y0+284, customgreymenu)"
			}
